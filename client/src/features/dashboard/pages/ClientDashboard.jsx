...
import "../../budget/components/BudgetEntryForm";
...
const ClientDashboard = () => {
  ...
  const toggleProjectStatus = async (project) => {
    ...
    try {
      await projectService.toggleProjectStatus(project.id, newStatus);
  ...
  const openBudgetModal = async (project) => {
    ...
    try {
      //all versions get
      const data = await budgetService.getBudgetVersions(project.id);
